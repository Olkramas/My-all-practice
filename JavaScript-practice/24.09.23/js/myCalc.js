...
function addFunc() {
    ...
    let addResult = "덧셈 결과는" + Number(num1.value) + Number(num2.value);
...
function subFunc() {
    let subResult = "뺄셈 결과는 " + Number(num1.value) - Number(num2.value);
    allResult.value = subResult;
}

function multyFunc() {
    let multyResult = "곱셈 결과는 " + Number(num1.value) * Number(num2.value);
    allResult.value = multyResult;

}

function dividFunc() {
    let divResult = "나눗셈 결과는 " + Number(num1.value) / Number(num2.value);
